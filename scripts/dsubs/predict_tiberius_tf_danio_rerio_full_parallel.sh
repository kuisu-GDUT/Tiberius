#!/bin/bash
#DSUB -n PREDICT_TIBERIUS_TF_DANIO_RERIO_FULL_PARALLEL
#DSUB -A root.project.P24Z10200N0983
#DSUB -R 'cpu=64;gpu=1;mem=150000'
#DSUB -N 1
#DSUB -eo /home/share/huadjyin/home/s_sukui/03_project/01_GeneLLM/Tiberius/logs/PREDICT_TIBERIUS_TF_DANIO_RERIO_FULL_PARALLEL.%J.%I.err
#DSUB -oo /home/share/huadjyin/home/s_sukui/03_project/01_GeneLLM/Tiberius/logs/PREDICT_TIBERIUS_TF_DANIO_RERIO_FULL_PARALLEL.%J.%I.out

### Load WC Env
source /home/HPCBase/tools/module-5.2.0/init/profile.sh
module use /home/HPCBase/modulefiles/
module purge
source ~/envs/env_py38_torch17
...
## Set scripts
RANK_SCRIPT="./scripts/predict_tiberius_tf_parallel.sh"
