...
WEIGHT_HUMAN_TFRecord_95=/home/share/huadjyin/home/s_sukui/03_project/01_GeneLLM/Tiberius/outputs/train_homo_sapiens_tiberius_pkls_from_tfrecord_10K/epoch_95
cd $TIBERIUS_ROOT

python test_data/val_model_pkl.py \
  --model $WEIGHT_HUMAN_TFRecord_95 \
  --batch_size 100 \
  --max_length 9999 \
  --learnMSA . \
